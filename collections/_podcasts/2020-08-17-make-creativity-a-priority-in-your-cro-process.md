...
Great, thanks for having me on. So what I do is I do conversion rate optimization cross with user experience research. So I started my career as a user experience researcher. And then I moved into conversion rate optimization. I was working at Google for a while and I got the chance to work on the Google optimized product and to see how people do CRM and what AV testing is all about, and decided to go and do that. So I worked for a company called clear head in Austin, Texas for a while. And then I started my own owning I started my own agency called experiment then three years ago,
...
Yesterday's brainstorm was so good. I really liked staffs idea of running that test on the call to action buttons, making them orange will really make them stand out, don't you think?
