...
# Download Three Useful Templates for Conversion Rate Optimization

This post references a few different templates to help you implement each step in the process of conversion rate optimization. Here’s what you need:

- Conversion Rate Checklist
- <a id="what-is-cro"></a>A/B Testing Template
- A/B Testing Statistical Confidence Calculator -->
